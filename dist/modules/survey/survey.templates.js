...
exports.surveyTemplates = void 0;
exports.surveyTemplates = {
    CUSTOMER_SATISFACTION: [
        {
            title: "Bonjour 👋 Merci pour votre achat chez [Nom de la marque]. Sur une échelle de 1 à 5, êtes-vous satisfait de votre expérience ?",
            type: "RATING",
            order: 1,
            minValue: 1,
            maxValue: 5,
    ...
    PRICE_TEST: [
        {
            title: "Bonjour 👋 Nous travaillons sur un nouveau produit. Seriez-vous prêt à acheter ce produit à quel prix ?",
            type: "SINGLE_CHOICE",
            order: 1,
            options: [
    ...
    PRODUCT_FEEDBACK: [
        {
            title: "Bonjour 👋 Nous aimerions avoir votre avis sur un nouveau produit. Que pensez-vous de ce produit ?",
            type: "SINGLE_CHOICE",
            order: 1,
            options: [
    ...
    CUSTOMER_RETENTION: [
        {
            title: "Bonjour 👋 Cela fait un moment que vous ne nous avez pas visités. Souhaitez-vous recevoir une offre spéciale ?",
            type: "YES_NO",
            order: 1,
            options: [
    ...
    BUSINESS_IDEA_VALIDATION: [
        {
            title: "Bonjour 👋 Seriez-vous intéressé par une application qui permet de [concept] ?",
            type: "SINGLE_CHOICE",
            order: 1,
            options: [
                { label: "Oui", value: "yes", order: 1 },
